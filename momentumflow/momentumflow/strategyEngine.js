// STRATEGY ENGINE v18.2 TIGHTER COST CONTROL
//
// v18.2 change (profitability tuning, unvalidated by backtest — watch paper results):
// - maxEquitySpreadPct 0.20% -> 0.10%, maxCryptoSpreadPct 0.65% -> 0.30%.
//   Spread was previously allowed to eat 36-54% of the minimum take-profit
//   target on marginal setups; this caps that closer to 18-25%.
// - trailingTriggerR 0.90 -> 0.65, so trades arm trailing protection earlier
//   instead of riding un-managed until the time-based max-hold exit fires.
// - equityMaxHoldMinutes 25 -> 38, giving equity trades more room to reach
//   target or trail before being force-closed at whatever price they're at.
//
// v18.1 change:
...
export const STRATEGY_DEFAULTS = {
  ...
  trailingTriggerR: 0.65,
  trailingDistanceR: 0.60,

  equityMaxHoldMinutes: 38,
