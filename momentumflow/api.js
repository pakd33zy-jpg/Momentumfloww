...
export const api = {
  ...
  setTradingConfig: (cfg) => request('/trading-config', { method: 'POST', body: JSON.stringify({ startingCapital: Number(cfg?.startingCapital ?? cfg), riskPerTrade: Number(cfg?.riskPerTrade ?? 0.02) }) }),
