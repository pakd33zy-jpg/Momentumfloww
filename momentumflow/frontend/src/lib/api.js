...
export const api = {
  ...
  runPaperSession: (startingCapital) => request('/sessions/paper/run', { method: 'POST', body: JSON.stringify({ startingCapital }) }),
  ...
  setTradingConfig: (cfg) => request('/trading-config', { method: 'POST', body: JSON.stringify({ startingCapital: Number(cfg?.startingCapital ?? cfg) }) }),
